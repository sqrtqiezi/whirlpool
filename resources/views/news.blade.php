...
@section('content')
    <div class="content content-news">
        ...
        <div class="grid-cell grid-cell-no-3">
            <div class="news-item news-item-lg flipInY animated">
                <img src="/images/news-item-1.png" alt="">
        ...
        <div class="grid-cell grid-cell-no-11">
            <div class="news-item flipInY animated">
                <img src="/images/news-item-2.png" alt="">
                <a href="{{ route('newsDetail', 1) }}">
                    <span>
                        惠而浦中国携手安徽绿地
                    </span>
        ...
        <div class="grid-cell grid-cell-no-13">
            <div class="news-item news-item-lg flipInY animated">
                <img src="/images/news-item-3.png" alt="">
                <a href="{{ route('newsDetail', 1) }}">
                    <span>
        ...
        <div class="grid-cell grid-cell-no-16">
            <div class="news-item flipInY animated">
                <img src="/images/news-item-4.png" alt="">
                <a href="{{ route('newsDetail', 1) }}">
                    <span>
                        惠而浦中国携手安徽绿地
                    </span>
        ...
        <div class="grid-cell grid-cell-no-21">
            <div class="news-item flipInY animated">
                <img src="/images/news-item-5.png" alt="">
                <a href="{{ route('newsDetail', 1) }}">
                    <span>
                        惠而浦中国携手安徽绿地
                    </span>
