...
@section('content')
    <div class="content content-products">
        ...
        <section class="grid-cell grid-cell-no-3">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-1" data-product-name="吸油烟机">
                <img src="/images/product-xyyj.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-4">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-2" data-product-name="灶具">
        ...
        <section class="grid-cell grid-cell-no-9">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-3" data-product-name="微波炉">
                <img src="/images/product-wbl.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-10">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-4" data-product-name="蒸箱">
        ...
        <section class="grid-cell grid-cell-no-12">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-5" data-product-name="消毒柜">
                <img src="/images/product-xdg.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-13">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-6" data-product-name="烤箱">
                <img src="/images/product-kx.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-14">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-7" data-product-name="酒柜">
                <img src="/images/product-jg.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-15">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-8" data-product-name="暖碟机">
                <img src="/images/product-ndj.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-16">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-9" data-product-name="洗碗机">
                <img src="/images/product-xwj.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-17">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-10" data-product-name="嵌入式冰箱">
                <img src="/images/product-qrsbx.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-18">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-11" data-product-name="干衣机">
                <img src="/images/product-xwj.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
        <section class="grid-cell grid-cell-no-19">
            <a href="{{ route('category', 1) }}" class="product-item fadeIn animated animated-12" data-product-name="垃圾处理器">
                <img src="/images/product-xwj.png" alt="">
                <i class="fa fa-search" aria-hidden="true"></i>
            </a>
        </section>
